...
package org.hpp.terrain.libnoise.model;
...
public class Line
{
   ...
   /// @pre The start and end TerrainPoints of the line segment were specified.
   ///
   ...
   public void setEndTerrainPoint (double x, double y, double z)
   {
      x1 = x;
      y1 = y;
      z1 = z;
   ...
   public void setStartTerrainPoint (double x, double y, double z)
   {
      x0 = x;
      y0 = y;
      z0 = z;
